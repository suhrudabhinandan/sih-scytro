...
const initializeCamera = async () => {
  try {
    ...
    // Try to select the back camera (environment facing)
    ...
    setError('Camera initialization failed. Please check permissions, close other apps using the camera, and try again.');
